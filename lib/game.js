...
class Game {
  ...
  showInstructionsScreen(){
    ...
    let message = new createjs.Text("Your beautiful, classy red carpet is under attack by a swarm of nasty kitties. Click and drag them into kitty jail! Click when ready.", 'bold 24px Arial', 'white');
